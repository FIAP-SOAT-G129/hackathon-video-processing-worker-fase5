# ⚙️ Hackathon — Worker de Processamento de Vídeos
...
Este repositório implementa o **Worker de Processamento de Vídeos**, desenvolvido em **Java 21 com Spring Boot 3 e Spring AMQP**. Ele é responsável por consumir mensagens de uma fila RabbitMQ, processar vídeos (extrair frames usando FFmpeg) e gerar arquivos ZIP com os frames, além de notificar o status do processamento.
